...
*
************************************************************************
      DIMENSION Q(MAXORB), COORD(3,NUMATM)
     ...
     1          FLEPO(16)*58, ITER(2)*58, NUMBRS(11)*1, GETNAM*80
      CHARACTER*2 ELEMNT, IELEMT(20), CALTYP*8, NAMFIL*80
...
C          CAN BE USED BY THE PATH OPTION)
      ...
      WRITE(6,'(//30X,A8,''  CALCULATION'')')CALTYP
...
c@s      CALL MULLIK(C,H,F,NORBS,P,RXYZ)
         CALL MULLIK(C,CBETA,UHF,H,F,NORBS,P,RXYZ,eigs,eigb)
