...
$ AUTO = ""
$!
$!  DO NOT CHECK ARRAY BOUNDS     - THIS IS A PRODUCTION PROGRAM
$!  DO NOT CHECK INTEGER OVERFLOW - THIS IS A PRODUCTION PROGRAM
$!
$FORTRAN:==FORTRAN
$ METHOD:== FORTRAN/CHECK=(NOBOUNDS,NOOVERFLOW)/OPTIMIZE
...
$ IF F$EXT(0,6,LINE).EQS."DZRO_M" THEN GOTO READ_LINE
$ L2=F$LOC(",",LINE)
$ P1 = F$EXT(0,L2,LINE)
