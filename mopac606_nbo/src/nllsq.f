...
C#      WRITE(6,730) SSQ
  ...
  590 CONTINUE
      ...
      IF(RESFIL)THEN
         ...
         WRITE(0,600)TLEFT,SQRT(SSQ),ESCF
  600    FORMAT('  RESTART FILE WRITTEN,  TIME LEFT:',F8.1,
     ...
     1MIN(TLEFT,9999999.9D0),MIN(SQRT(SSQ),999999.999D0),ESCF
         IF(MINPRT) WRITE(0,610)ICYC,MIN(TCYCLE,9999.99D0),
     1MIN(TLEFT,9999999.9D0),MIN(SQRT(SSQ),999999.999D0),ESCF
         IF(LOG) WRITE(11,610)ICYC,MIN(TCYCLE,9999.99D0),
     1MIN(TLEFT,9999999.9D0),MIN(SQRT(SSQ),999999.999D0),ESCF
  610    FORMAT(' CYCLE:',I5,' TIME:',F6.1,' TIME LEFT:',F8.1,
     1' GRAD.:',F10.3,' HEAT:',G14.7)
      ENDIF
