...
#if wxUSE_DRAG_AND_DROP
//  2013/12/04 Toshi Nagata
//  Implementation of wxTextCtrl sets an invalid value to m_dropTarget
//    if ( m_dropTarget != NULL )
    if (m_dropTarget != NULL && m_dropTarget != reinterpret_cast<wxDropTarget *>(1))
//  End Toshi Nagata
    {
        m_dropTarget->Revoke(m_hWnd);
