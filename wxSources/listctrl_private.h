...
private:
    ...
    void ApplyAttributes(wxDC *dc,
                         const wxRect& rectHL,
                         bool highlighted,
                         bool current, wxListItemAttr *override = NULL); // 2013.12.10. Add "override" argument
...
public:
	...
	//  2014.01.14. Toshi Nagata
	//  Sync the header window position with the list main window
	void QueueListCtrlEvent(wxCommandEvent &event);
	void OnListCtrlEvent(wxCommandEvent &event);
	//  End Toshi Nagata
