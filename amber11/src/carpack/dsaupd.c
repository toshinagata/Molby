/* dsaupd.f -- translated by f2c (version 20030306).
	...
	ftnlen bmat_len, ftnlen which_len)
{
    ...
    static char fmt_1000[] = "(/,5x,\002===================================="
	    ...
	    "5x,\002= Version Date:  \002,\002 07/31/96\002,14x,\002 =\002,/5"
	    "x,\002==========================================\002,/5x,\002= S"
...
/*        %--------------------------------------------------------% */
	...
	do_fio(&c__1, (char *)&timing_1.tsaupd, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tsaup2, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tsaitr, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.titref, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tgetv0, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tseigt, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tsgets, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tsapps, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tsconv, (ftnlen)sizeof(doublereal));
	e_wsfe();
    }
