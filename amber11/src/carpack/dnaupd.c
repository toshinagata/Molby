/* dnaupd.f -- translated by f2c (version 20030306).
...
/* \SCCS Information: @(#) */
/* FILE: naupd.F   SID: 2.6   DATE OF SID: 5/19/98   RELEASE: 2 */
	...
	ftnlen bmat_len, ftnlen which_len)
{
    ...
    static char fmt_1000[] = "(/,5x,\002===================================="
	    "=========\002,/5x,\002= Nonsymmetric implicit Arnoldi update cod"
	    "e =\002,/5x,\002= Version Number: \002,\002 2.4\002,21x,\002 "
...
/*        %--------------------------------------------------------% */
	...
	do_fio(&c__1, (char *)&timing_1.tmvopx, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tmvbx, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tnaupd, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tnaup2, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tnaitr, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.titref, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tgetv0, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tneigh, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tngets, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tnapps, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.tnconv, (ftnlen)sizeof(doublereal));
	do_fio(&c__1, (char *)&timing_1.trvec, (ftnlen)sizeof(doublereal));
	e_wsfe();
    }
